...
I will start with a review of things you have seen previously.

We know how to take derivatives of polynomial functions such as
\[
    y = x^4 + 3x^2 + 5x + 1
\]
and maybe you have also seen
\[
    f(x) = e^x
\]
before. But what happens if we combine them?
...
Next, what happens if we have three functions,
\[
    f(x) = a(x)b(x)c(x)?
\]
