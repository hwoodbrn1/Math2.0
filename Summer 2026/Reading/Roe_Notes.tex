...
\begin{theorem}[Rellich's Theorem]
...
The proof of this fact relies on the existence of a formal adjoint of $D$. 

While the graph of $\overline{D}$ is closed in $H\oplus H$, its domain is still not all of $L^2(S)$. 
Its domain consists of all $x \in L^2(S)$ such that there is a sequence $x_j$ of smooth sections 
converging to $x$ in $L^2(S)$ and that $Dx_j$ converges in $L^2(S)$. By Garding's inequality,
this domain is precisely the Sobolev space $H^1(S)$. 
